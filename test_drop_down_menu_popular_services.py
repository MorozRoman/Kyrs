...
class test_drop_down_menu_popular_services(unittest.TestCase):
    ...
    def test_Drop_down_menu_popular_services(self):
        ...
        self.assertEqual(len(wd.find_elements_by_xpath('//div[contains(@class, "mos-layouts-services_menu-popular")]/ul/li')), 6)
        ...
        wd.find_element_by_class_name('mos-header__main-bar_logo').click()
